...
export class MarvelService {
    ...
    private charactersSub: BehaviorSubject<Array<any>> = new BehaviorSubject(this.characters);
    /** Observable to subscribe to watch changes */
    public charactersObs: Observable<Array<any>> = this.charactersSub.asObservable();
     ...
     */
    public fetchCharacters(options: { limit: number, nameStartsWith: string, offset: number }): Observable<any> {
